...
\mfigure{Diziplinen im Bereich Neurale Netzwerke}{figures/tasks/nn_areas_venn.pdf}{fig:chen:cnn_task}
...
\mfigure{Bildauschnitt mit ground ground truh (0: Hintergrund, 3: Haupttext)}{figures/tasks/chen_examples.pdf}{fig:chen:cnn_task}
